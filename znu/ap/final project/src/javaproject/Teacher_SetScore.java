...
public class Teacher_SetScore extends javax.swing.JFrame {
    ...
    static void main(ArrayList<studentInfo> LS, ArrayList<TeacherInfo> LT, ArrayList<ClassInfo> LC, String id) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                Teacher_SetScore obj = new Teacher_SetScore();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int Nomreh = Integer.parseInt(jTextField4.getText());
        tinfo.setScore( ClassName, Name, Family,Nomreh,ListStudent);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Teacher_SetScore.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Teacher_SetScore().setVisible(true);
            }
        });
    }
