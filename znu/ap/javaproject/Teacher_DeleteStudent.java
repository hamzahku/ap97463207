...
public class Teacher_DeleteStudent extends javax.swing.JFrame {
    ...
    static void main(ArrayList<studentInfo> LS, ArrayList<TeacherInfo> LT, ArrayList<ClassInfo> LC, String id) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                Teacher_DeleteStudent obj = new Teacher_DeleteStudent();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("نام خانوادگی دانشچو :");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        obj.deleteStudent(Name,Family,ClassName,ListStudent);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Teacher_DeleteStudent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Teacher_DeleteStudent().setVisible(true);
            }
        });
    }
